...
*/
//https://github.com/avrj/slack-clone/blob/master/src/client/components/Chat.js
...
class App extends Component {
  // this is a constructor it calls when object is defined and it sets the values
  constructor(props) {
    super(props);
